...
from myapp.views import (
    ...
    choose_plan,
    upload_challan,
    admin_plans,front_page,
    view_challan,
    reject_challan,
    Home,login_view,logout_main,main_products_detail,upload_product_on_shop,shops_data_home,cart_main,shop_cart,
    allow_main,reject_shop_request,verify_shop_f,my_shop,forget_id,shop_data,shop_overall,admin_verification,
    main_products_api,order_now,open_your_shop,show_shop_data,approve_shop,shopping_stores,shop_api,shop_approved_api
)
urlpatterns=[
    ...
    path('main/home/login/main/order_now/check_cart/remove_from_cart/<int:id>/',remove_from_cart),
    path('main/home/login/main/check_cart/',check_cart),
    path('main/home/login/main/check_cart/remove_from_cart/<int:id>/',remove_from_cart),
    ...
    path('main/home/login/main/upload_products/select_plan/upload_challan/',upload_challan),
    ...
    path('main/home/login/main/upload_products/paid_plan/select_plan/upload_challan/',upload_challan),
    ...
    path('main/home/login/main/shopping_store/shops_data_home/<int:id>/',shops_data_home),
    path('main/home/login/main/shopping_store/shops_data_home/<int:id>/shops_cart/<int:id2>/',shop_cart),
    ...
    path('login/main/shopping_store/shops_data_home/<int:id>/shops_cart/<int:id2>/',shop_cart),
    ...
    path('login/main/open_your_shop/verify_shop/shop/<int:id>/upload/',upload_product_on_shop),
    ...
    path('login/main/order_now/check_cart/remove_from_cart/<int:id>/',remove_from_cart),
    ...
    path('login/main/upload_products/paid_plan/select_plan/upload_challan/',upload_challan),
    ...
    # Api section 
    path('shop_approved_api/',shop_approved_api),
